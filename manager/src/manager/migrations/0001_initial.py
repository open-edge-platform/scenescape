  ...
  operations = [
      migrations.CreateModel(
          ...
          fields=[
              ...
              ('geometric_center', manager.fields.ListField(base_field=models.FloatField(), blank=True, default=manager.models.default_geometric_center, help_text='Geometric center offset [x, y, z] in meters from bottom center', null=True, size=None)),
              ...
              ('center_of_mass', manager.fields.ListField(base_field=models.FloatField(), blank=True, default=manager.models.default_center_of_mass, help_text='Center of mass offset [x, y, z] in meters from geometric center', null=True, size=None)),
              ...
              ('friction_coefficients', manager.fields.ListField(base_field=models.FloatField(), blank=True, default=manager.models.default_friction_coefficients, help_text='Friction coefficients [static, dynamic]', null=True, size=None)),
          ],
      ),
      migrations.CreateModel(
          name='BoundingBox',
      ...
      migrations.CreateModel(
          ...
          fields=[
              ...
              ('transforms', manager.fields.ListField(base_field=models.FloatField(), blank=True, default=list, size=None)),
      ...
      migrations.CreateModel(
          ...
          fields=[
              ...
              ('dims', manager.fields.ListField(base_field=models.FloatField(), default=list, size=None)),

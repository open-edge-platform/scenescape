...
urlpatterns = [
  ...
  path('radar/list/', views.RadarListView.as_view(), name='radar_list'),
  path('radar/create/', views.RadarCreateView.as_view(), name='radar_create'),
  path('radar/update/<int:pk>/', views.RadarUpdateView.as_view(), name='radar_update'),
  path('radar/delete/<int:pk>/', views.RadarDeleteView.as_view(), name='radar_delete'),
...
urlpatterns += [
  ...
  re_path(r'api/v1/(camera)/([^/]+)$', api.ManageThing.as_view()),
  re_path(r'api/v1/(radars)$', api.ListThings.as_view()),
  re_path(r'api/v1/(radar)$', api.ManageThing.as_view()),
  re_path(r'api/v1/(radar)/([^/]+)$', api.ManageThing.as_view()),

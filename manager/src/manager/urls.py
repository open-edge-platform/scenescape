...
urlpatterns += [
  ...
  re_path(r'api/v1/scene/(?P<scene_id>[0-9a-f]{8}(?:-[0-9a-f]{4}){3}-[0-9a-f]{12})/arkit-mapping-bundle$',
          api.SceneArkitMappingBundleView.as_view(), name='scene_arkit_mapping_bundle'),

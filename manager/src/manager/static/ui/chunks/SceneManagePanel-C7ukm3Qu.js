  ...
  l.useEffect(() => {
    ...
    return (
      ...
      re
        ...
        .catch((p) => {
          o || E(p.message || "Failed to load child");
        })
        .finally(() => {
          o || C(!1);
        }),
        ...
        e.jsxs(ue, {
          ...
          children: [
            e.jsx(d, {
              ...
              value: f[0],
              onChange: (o) => w([o.target.value, f[1], f[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-ty",
              ...
              value: f[1],
              onChange: (o) => w([f[0], o.target.value, f[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-tz",
              ...
              value: f[2],
              onChange: (o) => w([f[0], f[1], o.target.value]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-rx",
              label: "Rotation X (°)",
              value: v[0],
              onChange: (o) => N([o.target.value, v[1], v[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-ry",
              label: "Rotation Y (°)",
              value: v[1],
              onChange: (o) => N([v[0], o.target.value, v[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-rz",
              label: "Rotation Z (°)",
              value: v[2],
              onChange: (o) => N([v[0], v[1], o.target.value]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-sx",
              label: "Scale X",
              value: y[0],
              onChange: (o) => b([o.target.value, y[1], y[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-sy",
              label: "Scale Y",
              value: y[1],
              onChange: (o) => b([y[0], o.target.value, y[2]]),
              disabled: c,
            }),
            e.jsx(d, {
              id: "ss-child-sz",
              label: "Scale Z",
              value: y[2],
              onChange: (o) => b([y[0], y[1], o.target.value]),
              disabled: c,
            }),
          ],
        }),
      ...
      ((n = window.setTimeout(() => {
        ...
        (r = (x) => {
          ...
          if ((u(), m != null && m.success && m.filename)) {
            g({
              filename: m.filename,
              mediaUrl: m.mediaUrl || `/media/${m.filename}`,
            });
            return;
          }
          i(
            new Error(
              (m == null ? void 0 : m.error) || "Failed to save map snapshot",
            ),
          );
        }),
  ...
  const ie = () => {
    ...
    te = async (h) => {
      ...
      try {
        ...
        (await window.mapManager.setMapProvider(h, {
          containerId: je,
          lat: Number.isFinite(w) ? w : 37.7749,
          lng: Number.isFinite(v) ? v : -122.4194,
          zoom: Number.isFinite(N) && N > 0 ? N : 15,
    ...
    pe = l.useCallback(async () => {
      ...
      try {
        ...
        const w = document.getElementById("id_map_corners_lla"),
          v = document.getElementById("id_scale"),
          N = document.getElementById("id_output_lla");
        (w && (w.value = f.corners),
          v && f.scale && (v.value = f.scale),
          N && (N.value = "true"),
          window.mapManager.generateBounds());
        const y = await h.promise,
          b = Ee(),
          c = b.corners || f.corners;
        (await x({
          scale: b.scale || f.scale || "100",
          mapCornersLla: c,
          outputLla: "true",
          ...
          children: [
            e.jsx("div", {
              ...
              children: e.jsxs("div", {
                ...
                children: [
                  e.jsxs("div", {
                    className: "ss-geo-modal-header",
                    children: [
                      e.jsx("h2", {
                        className: "ss-geo-modal-title",
                        id: m,
                        children: "Position geospatial map",
                      }),
                      e.jsxs("div", {
                  ...
                  e.jsxs("div", {
                    className: "ss-geo-picker",
                    children: [
                      e.jsxs("div", {
                        className: "ss-geo-picker-toolbar",
                        children: [
                          e.jsxs(ee, {
                            id: "mapProvider",
                            label: "Provider",
                          ...
                          e.jsx("p", {
                            className: "ss-geo-picker-hint",
                            children:
                              "Pan, zoom, and rotate the map to frame the scene. Done captures a snapshot and WGS84 corners, then saves them to the scene.",
                          }),
                          V
                            ? e.jsx("p", {
                                className: "ss-geo-picker-error",
                                children: V,
                              })
                            : null,
                        ],
                      ...
                      e.jsx("div", {
                        className: "ss-geo-picker-map-wrap",
                        children: e.jsx("div", { id: je }),
                      }),
                      e.jsxs("div", {
...
function za({ open: t, sceneId: n, authToken: r, onClose: u, onSaved: _ }) {
  const g = We(),
    ...
    ea =
      ...
      !!I.trim() ||
      !!H.trim(),
    aa = !!z && /corner|lla|geo|map.?center|bearing|provider/i.test(z || ""),
    ta = !!z && /translation|rotation|mesh|pose|scale_[xyz]/i.test(z || ""),
    na =
      !!z &&
        ...
        children: e.jsxs(ca, {
          ...
          children: [
            e.jsx(ue, {
              ...
              title: "Identity",
              description:
                "How this scene appears in the gallery and navigation.",
              children: e.jsx(d, {
            ...
            e.jsxs(ue, {
              ...
              title: "Map",
              description:
                "Floor plan image or geospatial basemap and scene scale.",
              children: [
                e.jsxs(ee, {
            ...
            e.jsxs(ue, {
              ...
              title: "Tracking",
              description:
                "How often scene detections and external updates are published.",
              children: [
                e.jsxs(ee, {
            ...
            e.jsxs(
              ue,
              {
                ...
                description:
                  "WGS84 corners and LLA output for Mapbox / Google Maps scenes.",
                collapsible: !0,
                defaultOpen: !m && ea,
                forceOpen: aa,
                className: "ss-form-section--columns",
                children: [
                  ...
                  e.jsxs(ee, {
                    ...
                    children: [
                      ...
                      e.jsx("option", { value: "mapbox", children: "Mapbox" }),
                    ],
                  }),
                  e.jsx(d, {
            ...
            e.jsxs(
              ue,
              {
                ...
                description:
                  "Feature matching and marker settings for camera auto-calibration.",
                collapsible: !0,
                defaultOpen: !1,
                forceOpen: na,
                children: [

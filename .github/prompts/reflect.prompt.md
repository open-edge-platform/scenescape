...
3. Suggest specific additions or modifications to the `.github/copilot-instructions.md`, files under `.github/instructions` directory, `Agents.md` in each service directory and other relevant documentation to prevent these issues in the future.

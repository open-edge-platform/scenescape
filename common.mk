...
EXTRA_BUILD_ARGS += --cache-from "type=registry,ref=ghcr.io/${CACHE_REGISTRY}/cache-$(IMAGE):${CACHE_TAG}" --cache-from "type=registry,ref=ghcr.io/${CACHE_REGISTRY}/cache-$(IMAGE):main" --cache-to "type=registry,ref=ghcr.io/${CACHE_REGISTRY}/cache-$(IMAGE):${CACHE_TAG},ignore-erro=true"
endif

...
class UUIDManager:
  ...
  def __init__(self, database=DEFAULT_DATABASE, reid_config_data=None,
               available_databases_override=None):
    self.active_ids = {}
    ...
    database_registry = (
      available_databases_override
      if available_databases_override is not None
      else available_databases
    )
    self.reid_database = database_registry[database](dimensions=None)

...
#### 5.6.7 DLSPS adapter migration to Gst Analytics Python API
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Phase 1** | **(3) Model Downloader adoption.**<br>**(7) DLSPS adapter migration to Gst Analytics Python API** (starts; may continue into subsequent phases). | `model_installer` is removed. DLSPS adapter migration to Gst Analytics Python API is underway.                                                               |

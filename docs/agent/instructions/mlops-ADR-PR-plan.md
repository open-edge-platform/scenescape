...
The documents created are deliverables for the phase 1 (OEP 2026.1 release). The feature is planned to be delivered in phases in next releases (2026.2+).
JIRA item created for 2026.2 release (ITEP-92811.xml) defines the exact scope for the second phase. Full plan can be found in the presentation extract Slide 9: VA Platform Integration: Proposed Timeline.
...
Inproving UX is definitely one of main motivations but not the only one: engineering efficiency, focusing on core SceneScape functionalities, reducing redundant efforts are equally important.

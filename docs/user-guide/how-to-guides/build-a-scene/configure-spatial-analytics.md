...
> **Need help working with spatial analytics data?** See the [Working with Spatial Analytics Data](../../working-with-spatial-analytics-data.md) guide for details on consuming ROI and tripwire events via MQTT, including Python and JavaScript examples and data format specifications.
...
- [Working with Spatial Analytics Data](../../working-with-spatial-analytics-data.md) - Learn how to consume and process the spatial analytics data generated by ROIs and Tripwires

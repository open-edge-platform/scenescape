...
[ADR 16](https://github.com/open-edge-platform/scenescape/blob/release-2026.2.0/docs/adr/0016-unified-external-source-ingestion.md).
...
background:
[ADR 16 — Unified External-Source Ingestion](https://github.com/open-edge-platform/scenescape/blob/release-2026.2.0/docs/adr/0016-unified-external-source-ingestion.md).

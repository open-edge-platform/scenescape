...
Download the required models for License Plate Detection and Optical Character Recognition to the following location `scenescape/model_installer/models/public/`. For more information, refer to [DL Streamer documentation](https://github.com/open-edge-platform/dlstreamer/tree/v2026.2.0/samples/gstreamer/gst_launch/license_plate_recognition#models).
...
```Dockerfile
FROM docker.io/intel/dlstreamer-pipeline-server:2026.2.0-ubuntu24
...
The `deepscenario-config.json` file can be edited based on the [DL Streamer Pipeline Server documentation](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-libraries/dlstreamer-pipeline-server/index.html) to customize:

...
> **Note**: To run DL Streamer Pipeline Server pipelines on hardware accelerators (GPU or NPU), see the DL Streamer Pipeline Server service [README.md](/dlstreamer-pipeline-server/README.md).

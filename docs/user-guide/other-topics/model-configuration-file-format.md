...
Refer to the instructions in [`model_installer` documentation](https://github.com/open-edge-platform/scenescape/blob/release-2026.0/model_installer/src/README.md) on the Models Volume folder structure.
...
- [`model_installer` documentation](https://github.com/open-edge-platform/scenescape/blob/release-2026.0/model_installer/src/README.md)

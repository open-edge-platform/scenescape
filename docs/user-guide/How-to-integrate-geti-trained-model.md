...
1. **Place your Intel® Geti™ model** in `[PROJECT_DIR]/model_installer/models-vol/ovms`. Ensure the directory structure matches the [OpenVINO™ Model Server model layout](https://docs.openvino.ai/2022.2/ovms_docs_models_repository.html).

...
A `tracker-config.json` file is pre-stored in the [`config` directory](https://github.com/open-edge-platform/scenescape/tree/release-2026.1.0/controller/config) in the repository.

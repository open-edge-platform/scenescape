  ...
  def generateCalibration(self, sceneobj, camera_intrinsics, cam_frame_data):
    ...
    try:
      ...
      if (cur_cam_calib_obj.result_data_3d is None
        ...
        raise TypeError((f"Fewer than {MIN_APRILTAG_COUNT} tags found in {sceneobj.name}'s map. Make sure there are at least {MIN_APRILTAG_COUNT} tags clearly visible in the scene map."))

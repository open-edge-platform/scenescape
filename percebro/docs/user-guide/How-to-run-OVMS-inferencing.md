...
1. Put the Geti model in directory `[PROJECT_DIR]/model_installer/models-vol/ovms`. Make sure the directory structure matches with the [directory structure mentioned here](https://docs.openvino.ai/2024/ovms_docs_models_repository.html)

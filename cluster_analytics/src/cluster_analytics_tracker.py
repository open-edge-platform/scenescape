...
class ClusterTracker:
    ...
    def processNewDetections(self, scene_id: str, new_cluster_detections: List[Dict],
        ...
        2. For each category:
           a. Get existing tracked clusters
           b. Match new detections to existing
           c. Update matched clusters
           d. Create new clusters for unmatched detections
           e. Mark undetected clusters as missed
        3. Cleanup old/lost clusters

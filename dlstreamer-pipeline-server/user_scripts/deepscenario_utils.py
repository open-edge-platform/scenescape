...
if 82 - 82:
    Iii1i
if 87 - 87:
    Ii % i1i1i1111I . Oo / OooOoo * I1Ii1I1 - I1I
...
def ooo0oOoooOOO0(slice_obj, shift):
    ...
    if 84 - 84:
        ooo000 - Ooo0Ooo + iI1iII1I1I1i . IIiIIiIi11I1
    if 98 - 98:
        I11iiIi11i1I % oOO
...
def i1ii1(pts_2d, depths, calibs):
    ...
    if 26 - 26:
        O0OooooOo + ii % iiI * IIi1i111IiII . iIIIII1i111i / IIiiii1IiIiII
    calibs = calibs . reshape(- 1, 3, 4)
    if 32 - 32:
        O0OooooOo
    i1iiiiIIIiIi = depths - calibs[:, 2, 3]
    II = (pts_2d[:, 0] * depths - calibs[:, 0, 3] -
          calibs[:, 0, 2] * i1iiiiIIIiIi) / calibs[:, 0, 0]
    OO0000 = (pts_2d[:, 1] * depths - calibs[:, 1, 3] -
              calibs[:, 1, 2] * i1iiiiIIIiIi) / calibs[:, 1, 1]
    oOoo0 = np . stack([II, OO0000, i1iiiiIIIiIi], axis=1)
    if 95 - 95:
        IIiIIiIi11I1 . Ii . ii % iiI % I1Ii1I1
    return oOoo0
    if 8 - 8:
        I1Ii1I1 . IIiiii1IiIiII . ooo000 . Oo - iIIIII1i111i
    if 32 - 32:
        Ii % i1i1i1111I % iIIIII1i111i - iiI % IIiIIiIi11I1
...
def o0OoOOo00OOO(bboxes):
    ...
    return bboxes
    if 17 - 17:
        ooo000 . iI1iII1I1I1i + I1Ii1I1
    if 57 - 57:
        iI1iII1I1I1i * iiI % IIi1i111IiII . Oo + OooOoo
...
def o00(bboxes):
    ...
    return bboxes
    if 20 - 20:
        IIiiii1IiIiII + IIiIIiIi11I1 / I1I
    if 88 - 88:
        iiI + Ooo0Ooo - i1i1i1111I . iI1iI11Ii111 * Ii + Iii1i
...
def oOo0O00O0ooo(prediction, num_classes, conf_thre=0.7, nms_thre=0.45,
    ...
    if 40 - 40:
        I11iiIi11i1I . ooo000 / Oo
    O0ooooOoo0O = [None for _ in range(len(prediction))]
    for oo0oOo, oOOOo in enumerate(prediction):
        if 29 - 29:
            I1I
        if 52 - 52:
            i1i1i1111I + I11iiIi11i1I + iiI
        if not oOOOo . size(0):
            continue
            if 52 - 52:
                IIiIIiIi11I1 % Oo . I1Ii1I1 + Ooo0Ooo % Oo . IIiiii1IiIiII
        OOO00oO0oOo0O, iIi1I1I = torch . max(
            oOOOo[:, - num_classes:], 1, keepdim=True)
        if 85 - 85:
            iI1iII1I1I1i
        OO0O0oo = (oOOOo[:, 4] * OOO00oO0oOo0O . squeeze()
                   >= conf_thre) . squeeze()
        if 54 - 54:
            I1Ii1I1 - iIIIII1i111i % oOO + Iii1i % iI1iII1I1I1i + I1I
        OOO0o0O0o = torch . cat(
            (oOOOo[:, : 5], OOO00oO0oOo0O, iIi1I1I . float()), 1)
        ...
        if prediction . shape[2] >= num_classes + 5:
            OOO0o0O0o = torch . cat(
                (OOO0o0O0o, oOOOo[OO0O0oo][:, 5: - num_classes]), dim=1)
            if 32 - 32:
                i1i1i1111I % iI1iI11Ii111 - iIIIII1i111i * I1I
        O0ooooOoo0O[oo0oOo] = OOO0o0O0o[o0Ooo]
        if 92 - 92:
            ii - ooo000 - Iii1i / iI1iI11Ii111 . I1Ii1I1 / iiI
    return O0ooooOoo0O
    if 60 - 60:
        IIi1i111IiII
    if 32 - 32:
...
def i11ii1i1I(numpy_array_or_tensor):
    if isinstance(numpy_array_or_tensor, torch . Tensor):
        ...
        if 18 - 18:
            iiI * IIiiii1IiIiII % O0OooooOo + IIiiii1IiIiII
        if 93 - 93:
            IIi1i111IiII - I1Ii1I1 - ii * Ooo0Ooo - ooo000
...
def o00(bboxes):
    ...
    return bboxes
    if 31 - 31:
        IIiIIiIi11I1 + i1i1i1111I % OooOoo
    if 20 - 20:
        OooOoo - I1I
...
def II1IIiiI(rel_x_distance, rel_y_distance,
    ...
    if input_flat:
        ...
        if 50 - 50:
            Iii1i * oOO % Iii1i - iI1iII1I1I1i + oOO
    ...
    if not math . isclose(iIiIiiIIIiII, 0):
        if 44 - 44:
            iI1iI11Ii111 + i1i1i1111I + Iii1i - IIi1i111IiII
        I1i1i = np . array([- ooOOOoOO0[1], ooOOOoOO0[0], 0])
        I1i1i = iIiIiiIIIiII * I1i1i / np . linalg . norm(I1i1i)
        ii1ii = np . dot(
            Rotation . from_rotvec(I1i1i) . as_matrix(),
            alloc_rotation_matrix)
    else:
        ii1ii = alloc_rotation_matrix
        if 17 - 17:
            Oo * I1I % Ooo0Ooo - I11iiIi11i1I
    return ii1ii
    if 22 - 22:
        Oo % iI1iII1I1I1i / iIIIII1i111i . iI1iII1I1I1i . iIIIII1i111i
    if 87 - 87:
        I1I - iIIIII1i111i . ooo000 * Oo
...
class ooO0O0Oo00O:
    def __init__(self, do_tracking=False, do_ddd=False):
        ...
        self . do_ddd = do_ddd
        if 2 - 2:
            Oo - I11iiIi11i1I - O0OooooOo * OooOoo
        if 56 - 56:
            iiI * Ooo0Ooo
        self . _possible_dims = [
        ...
        if 79 - 79:
            O0OooooOo - iIIIII1i111i - IIiIIiIi11I1 + i1i1i1111I / Ooo0Ooo
        ...
        for OooOoO0oO in self . _possible_dims:
            if not (
                    self . do_tracking and OooOoO0oO['tracking']) and not (
                    self . do_ddd and OooOoO0oO['ddd']):
                continue
                if 85 - 85:
                    ii + iiI % iI1iI11Ii111 + IIi1i111IiII * IIiIIiIi11I1
            if OooOoO0oO['in_gt']:
            ...
            if OooOoO0oO['pred']:
                ...
                if 46 - 46:
                    Ooo0Ooo - Ooo0Ooo + Oo / I1I * Oo + IIi1i111IiII
            assert oooo0OO0o0 or not (
                OooOoO0oO['in_gt'] and OooOoO0oO['pred']), 'Wrong order of possible_dims'
            oooo0OO0o0 = OooOoO0oO['in_gt'] and OooOoO0oO['pred']
            if 98 - 98:
                I1I / ii / iIIIII1i111i + IIiiii1IiIiII % Oo + I1I

    @ property
    def tracking_offset(self):
        return self . used_dims['tracking_offset']
        if 38 - 38:
            I1Ii1I1 + iI1iII1I1I1i

    @ property
    def rot(self):
        return self . used_dims['rot']
        if 2 - 2:
            OooOoo % Ii + IIi1i111IiII . OooOoo + ii * Oo

    @ property
    def dim(self):
        return self . used_dims['dim']
        if 2 - 2:
            ii + O0OooooOo - I1Ii1I1 + Ooo0Ooo . ii
    ...
    def virtual_depth(self):
        ...
        if 81 - 81:
            OooOoo . iIIIII1i111i / i1i1i1111I + Oo / iI1iI11Ii111 % IIiiii1IiIiII

    @ property
    def amodal_offset(self):
        return self . used_dims['amodal_offset']
        if 77 - 77:
            iiI / O0OooooOo - iI1iII1I1I1i - iI1iI11Ii111 % iI1iII1I1I1i

    @ property
    def virtual_depth_logstd(self):
        return self . used_dims['virtual_depth_logstd']
        if 73 - 73:
            IIiiii1IiIiII . Oo * I1I / i1i1i1111I + I1Ii1I1
    ...
    def rgiou(self):
        ...
        if 1 - 1:
            IIiiii1IiIiII - iI1iII1I1I1i - ooo000 . iI1iII1I1I1i

    @ property
    def calib(self):
        return self . used_dims['calib']
        if 91 - 91:
            O0OooooOo * ooo000 . Ooo0Ooo

    @ property
    def visible_ratio(self):
        return self . used_dims['visible_ratio']
        if 81 - 81:
            I1I * Oo - ooo000 % OooOoo * Ooo0Ooo
    ...
    def keypoints_2d_offsets(self):
        ...
        if 19 - 19:
            Ii
        if 22 - 22:
            iIIIII1i111i % O0OooooOo + Oo


def decrypt(password, in_file):
    if 60 - 60:
        oOO + iiI + ii % i1i1i1111I - Ii % iI1iI11Ii111
    with open(in_file, 'r') as OoiI1iiI11IIi1:
        OOO = OoiI1iiI11IIi1 . readline()[: - 1]
        if 53 - 53:
            Oo + IIiIIiIi11I1 / iI1iI11Ii111
    OO0oOoOOOoO0 = argon2 . extract_parameters(OOO)
    Iii1I1I1 = argon2 . PasswordHasher(
        time_cost=OO0oOoOOOoO0 . time_cost,
        memory_cost=OO0oOoOOOoO0 . memory_cost,
        parallelism=OO0oOoOOOoO0 . parallelism,
        hash_len=OO0oOoOOOoO0 . hash_len,
        salt_len=OO0oOoOOOoO0 . salt_len)
    if 57 - 57:
        I1I
    if 35 - 35:
        iI1iII1I1I1i / ii - Iii1i . IIiiii1IiIiII * ooo000
    if 91 - 91:
        IIi1i111IiII + Iii1i
    if 71 - 71:
        ooo000 . O0OooooOo . OooOoo . ii
    if 92 - 92:
        Ooo0Ooo % ii - ii
    try:
        ...
        exit()
        if 32 - 32:
            OooOoo % I1I - iiI % OooOoo
        if 9 - 9:
            IIiIIiIi11I1 - Ooo0Ooo % Iii1i
    O00OoO0OOO0 = OOO . split("$")[- 2]
    if 98 - 98:
        O0OooooOo - I1I + ooo000 * oOO % ooo000
    if 100 - 100:
        IIiIIiIi11I1 . ii * oOO * oOO
    Iioo0Oo0oO0 = argon2 . low_level . hash_secret_raw(
        time_cost=OO0oOoOOOoO0 . time_cost,
        memory_cost=OO0oOoOOOoO0 . memory_cost,
        parallelism=OO0oOoOOOoO0 . parallelism,
        hash_len=OO0oOoOOOoO0 . hash_len,
        ...
        salt=bytes(
            O00OoO0OOO0,
            "utf_16_le"),
        type=OO0oOoOOOoO0 . type)
    if 20 - 20:
        ii
    if 34 - 34:
        oOO % i1i1i1111I * IIiIIiIi11I1
    if 87 - 87:
        IIiIIiIi11I1 - ii * Ii % i1i1i1111I % ooo000
    if 81 - 81:
        ooo000 + i1i1i1111I * Oo - Oo * I1Ii1I1 - iI1iII1I1I1i
    if 4 - 4:
        IIiIIiIi11I1
    if 8 - 8:
        I11iiIi11i1I + OooOoo - ooo000
    if 68 - 68:
        I1Ii1I1 % I1Ii1I1 / IIiiii1IiIiII . oOO
    if 80 - 80:
        ii / OooOoo % O0OooooOo / Ooo0Ooo * Ooo0Ooo - Iii1i
    O0ooOO0O0O0O = base64 . urlsafe_b64encode(Iioo0Oo0oO0)
    if 59 - 59:
        oOO / Oo - ooo000
    if 49 - 49:
        iIIIII1i111i + iI1iII1I1I1i + oOO . Iii1i + iIIIII1i111i
...
if 82 - 82:
    ooo000 . Iii1i - IIiiii1IiIiII
if 72 - 72:
    ooo000 % i1i1i1111I * O0OooooOo
...
def Ooo(outputs, img_size, class_ids, info_imgs,
    ...
    for o0oO0OOo, (O0ooooOoo0O, oOoOo0O00, oOooOo0o, iii1ii1) in enumerate(
            zip(outputs, info_imgs[:, 0], info_imgs[:, 1], img_ids)):
        if O0ooooOoo0O is None:
            continue
        O0ooooOoo0O = O0ooooOoo0O . cpu()
        if 27 - 27:
            ooo000 / OooOoo + Iii1i % OooOoo + OooOoo
        o0o = O0ooooOoo0O[:, 0: 4]
        if 17 - 17:
            I11iiIi11i1I
        if 31 - 31:
            Iii1i + Ooo0Ooo / OooOoo . iI1iI11Ii111 * iiI
        iII11iI1i = min(
            img_size[0] /
            float(oOoOo0O00),
            img_size[1] /
        ...
        if 80 - 80:
            IIi1i111IiII % IIiIIiIi11I1 * IIiiii1IiIiII - iI1iII1I1I1i % iiI - IIiiii1IiIiII
        ...
        if 13 - 13:
            I11iiIi11i1I * IIi1i111IiII / iIIIII1i111i . IIi1i111IiII % Oo + iI1iI11Ii111
        OoO0OOo00oo0O(
            O0ooooOoo0O,
            OoOOO0OOo0Ooo,
            oo0000oOOoOOO,
    ...
    if 29 - 29:
        I11iiIi11i1I
    if 72 - 72:
        Ooo0Ooo . ooo000 % iI1iI11Ii111


def IiOOooo00(image_wise_data):
    o00o = []
    for iii1ii1, iIIIiII1 in image_wise_data . items():
        o0o = o0OoOOo00OOO(np . asarray(
            iIIIiII1['bboxes']) . reshape(- 1, 4)) . tolist()
    ...
    return o00o
    if 97 - 97:
        I11iiIi11i1I . Oo - iIIIII1i111i + iiI - iI1iII1I1I1i
    if 6 - 6:
        IIiiii1IiIiII - Ii
...
def iiiIII(virtual_depth_ratio, amodal_center, calib,
    ...
    if 66 - 66:
        iiI . I1I % I11iiIi11i1I + OooOoo * Oo / OooOoo
    if 33 - 33:
        IIiiii1IiIiII / OooOoo
...
def OoO0OOo00oo0O(output, image_data, dd_centers, calib,
    ...
    if 11 - 11:
        OooOoo * iI1iII1I1I1i + oOO * IIiiii1IiIiII / i1i1i1111I
    II1iiIiI1i1 = output[:, II1iiIiI1i1] . reshape(- 1, 8, 2) . numpy()
    if 40 - 40:
        IIiIIiIi11I1 - iiI / iI1iI11Ii111 . I11iiIi11i1I % Iii1i
    OoOO = IIi + dd_centers
    if 25 - 25:
        OooOoo / i1i1i1111I
    o000o0O0o0, oo00 = [], []
    for IIo0O0Oo0oO, o00OOOO, o0oOo in zip(oOOOOO0 . numpy(), OoOO . numpy(),
        ...
        if 92 - 92:
            OooOoo + Ii / ii + OooOoo * ii * O0OooooOo
    image_data . update({
...
def Iii(img_ids, dim_manager, * args, ** kwargs):
    ...
    if 54 - 54:
        O0OooooOo % Oo . IIiiii1IiIiII - Iii1i % iiI * iIIIII1i111i
    if 31 - 31:
        iI1iII1I1I1i / Iii1i - I11iiIi11i1I % iIIIII1i111i / I1Ii1I1 - i1i1i1111I
...
def preprocess(input_image, input_calib,
    ...
    if 57 - 57:
        I1Ii1I1 + ii - iiI + Ooo0Ooo
    Oo0oOO = torch . stack([Oo0oOO, Oo0oOO], dim=0) . reshape(
        1, 2, * Oo0oOO . shape[1:])
    return Oo0oOO, IiIII1
    if 11 - 11:
        i1i1i1111I - IIiiii1IiIiII - IIi1i111IiII / \
            IIiIIiIi11I1 + i1i1i1111I . IIiIIiIi11I1
    if 85 - 85:
        O0OooooOo + iI1iI11Ii111 % I1Ii1I1
...
def postprocess(ov_output, calib, input_size, class_ids, score_threshold=0.3,
    ...
    if 10 - 10:
        oOO * iiI + I1Ii1I1 * OooOoo . O0OooooOo % Ii
    ...
    if 67 - 67:
        Oo % Ooo0Ooo + O0OooooOo * I1I
    OoooO = torch . Tensor(ov_output . get('output'))
    I1Io0OOo0000o = oOo0O00O0ooo(
        OoooO,
        Oo0O0OO0o,
        score_threshold,
        nms_threshold)[0]
    if 47 - 47:
        Oo / OooOoo / ii / I11iiIi11i1I . IIi1i111IiII
    Oo0ooOO00O = np . asarray([input_size])
    if 68 - 68:
        iIIIII1i111i - OooOoo . i1i1i1111I + O0OooooOo
    ...
    if 39 - 39:
        i1i1i1111I % I1Ii1I1 % iIIIII1i111i % I1Ii1I1 / IIiiii1IiIiII
    if 93 - 93:
        iIIIII1i111i + Iii1i . Ii . iIIIII1i111i * Ooo0Ooo
...
def IiI1IiIi11Ii1(data_list):
    ...
    return data_list
    if 88 - 88:
        O0OooooOo + Ii . O0OooooOo / iI1iI11Ii111
    if 62 - 62:
        IIiIIiIi11I1 / OooOoo % IIiIIiIi11I1 + I11iiIi11i1I

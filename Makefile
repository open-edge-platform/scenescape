...
prettier-check:
	...
	@npx prettier --check . --ignore-path .gitignore --ignore-path .github/resources/.prettierignore --config .github/resources/.prettierrc  || (echo "Prettier check failed - run `make prettier-write` to fix" && exit 1)

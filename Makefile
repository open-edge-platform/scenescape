...
build-coverity:
	...
	@export OpenCV_DIR="/usr/lib/x86_64-linux-gnu/cmake/opencv4" && cd controller/src/robot_vision && pip3 install --no-cache-dir --no-build-isolation . || (echo "robot vision build failed" && exit 1)

...
IMAGE_FOLDERS := $(CORE_IMAGE_FOLDERS) mapping cluster_analytics tracker ptz_pose_service
...
autocalibration controller manager analytics mapping cluster_analytics ptz_pose_service: build-common

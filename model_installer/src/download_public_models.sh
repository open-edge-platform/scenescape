...
# ==============================================================================
#
# This script downloads and processes models. It requires dependencies to be
# pre-installed via install_dependencies.sh (typically during Docker image build).
...
if [ ! -d "$VENV_DIR_QUANT" ]; then
  echo "ERROR: Virtual environment not found: $VENV_DIR_QUANT"
  echo "Please run install_dependencies.sh first to set up the environment."
  exit 1
fi

...
class Scene3dRoiUserInterfaceTest(UserInterfaceTest):
  ...
  def checkRoiControls(self, result_recorder):
    ...
    log.info("Create an ROI via the 2D scene page so it renders in the 3D control panel.")
    self.createRoi()
    ...
    # 1. Verify 3D ROI color changes with the color control.
    log.info("Change ROI color via the control panel.")
    ...
    # 2 & 4. The show toggle controls both the ROI and its child label.
    ...
    # 3. Verify 3D ROI opacity changes with the slider.
    log.info("Change ROI opacity via the control panel.")
    ...
    # 5. Verify 3D ROI height changes with the slider.
    log.info("Change ROI height via the control panel.")

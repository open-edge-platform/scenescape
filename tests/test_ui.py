...
UI_TESTS = [
  ...
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_camera_control_panel.py",
  ...
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_scene_control_panel.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_add_delete_3d_object.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_calibrate_all_sensor_types.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="camera_deletion",
    profile=BROKER_WEB,
    script="tests/ui/test_camera_deletion.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_camera_intrinsics.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_camera_perspective.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_delete_sensor_scene.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="delete_sensors",
    profile=BROKER_WEB,
    script="tests/ui/test_delete_sensors.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_different_formats_maps.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="timestamp_format",
    profile=BROKER_WEB,
    script="tests/ui/test_timestamp_format.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_manual_camera_calibration.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="object_crud",
    profile=BROKER_WEB,
    script="tests/ui/test_object_crud.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_restricted_media_access.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="scenes_summary",
    profile=BROKER_WEB,
    script="tests/ui/test_scenes_summary.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="sensor_area",
    profile=BROKER_WEB,
    script="tests/ui/test_sensor_area.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="sensor_location",
    profile=BROKER_WEB,
    script="tests/ui/test_sensor_location.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="sensor_scene",
    profile=BROKER_WEB,
    script="tests/ui/test_sensor_scene.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_superuser_crud_operations.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_upload_3d_glb_file.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=BROKER_WEB,
    script="tests/ui/test_upload_only_3d_glb_files.py",
    require_password=True,
    auth="",
  ),
  ...
  FuncTestSpec(
    ...
    profile=FULL_STACK,
    script="tests/ui/test_delete_sensor_mqtt.py",
    require_password=True,
  ...
  FuncTestSpec(
    id="view_3d_glb_file",
    profile=FULL_STACK,
    script="tests/ui/test_view_3d_glb_file.py",
    require_password=True,
    auth="",
  ),
  ...
  FuncTestSpec(
    ...
    profile=FULL_STACK,
    script="tests/ui/test_persistence_on_page_navigate.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    ...
    profile=FULL_STACK,
    script="tests/ui/test_persistence_on_restart.py",
    require_password=True,
    auth="",
  ),
  ...
  FuncTestSpec(
    ...
    script="tests/ui/test_3d_ui_calibration_points.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="camera_status",
    profile=FULL_STACK_WITH_VIDEO_AND_RETAIL,
    script="tests/ui/test_camera_status.py",
    require_password=True,
    auth="",
  ),
  FuncTestSpec(
    id="scene_details",
    profile=FULL_STACK_WITH_VIDEO_AND_RETAIL,
    script="tests/ui/test_scene_details.py",
    require_password=True,
    auth="",
  ),
  ...
  FuncTestSpec(
    ...
    script="tests/ui/test_auto_calibration_ui.py",
    require_password=True,
    auth="",
  ...
  FuncTestSpec(
    ...
    profile=AUTO_CALIBRATION_UI,
    script="tests/ui/test_calibrate_camera_3d_ui_2d_ui.py",
    require_password=True,
    auth="",
  ),
]

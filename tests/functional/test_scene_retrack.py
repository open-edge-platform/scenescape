...
def check_scene_retrack_disabled_objects_propagate_to_parent(
...
def check_scene_retrack_disabled_preserves_child_object_ids(
    objData, record_xml_attribute, params):
...
def check_scene_retrack_enabled_assigns_new_ids_to_child_objects(
    objData, record_xml_attribute, params):
...
def check_scene_retrack_toggle_changes_id_behaviour(
    objData, record_xml_attribute, params):
...
def check_external_topic_payload_has_required_fields(objData, record_xml_attribute, params):
...
def check_external_topic_translations_reach_parent_regulated(
    objData, record_xml_attribute, params):
...
def check_external_update_rate_limits_publish_frequency(
    objData, record_xml_attribute, params):
...
def test_scene_retrack_suite(objData, record_xml_attribute, params):
  check_scene_retrack_disabled_objects_propagate_to_parent(
    objData, record_xml_attribute, params)
  check_scene_retrack_disabled_preserves_child_object_ids(
    objData, record_xml_attribute, params)
  check_scene_retrack_enabled_assigns_new_ids_to_child_objects(
    objData, record_xml_attribute, params)
  check_scene_retrack_toggle_changes_id_behaviour(
    objData, record_xml_attribute, params)
  check_external_topic_payload_has_required_fields(
    objData, record_xml_attribute, params)
  check_external_topic_translations_reach_parent_regulated(
    objData, record_xml_attribute, params)
  check_external_update_rate_limits_publish_frequency(
    objData, record_xml_attribute, params)
